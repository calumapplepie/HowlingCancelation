classdef (Sealed,StrictDefaults) FreeSpaceCalum < phased.internal.AbstractFreeSpace
...
%
%   See also phased, phased.RadarTarget, phased.WidebandFreeSpace, fspl.
...
%#codegen
    ...
    properties (Nontunable) 
        ...
        TwoWayPropagation (1, 1) logical = false
    end
    ...
    methods
        function obj = FreeSpaceCalum(varargin)
    ...
    methods (Access = protected, Static, Hidden)
        function header = getHeaderImpl
          header = matlab.system.display.Header(...
              'Title',"FreeSpace (Calum Modified)",...
